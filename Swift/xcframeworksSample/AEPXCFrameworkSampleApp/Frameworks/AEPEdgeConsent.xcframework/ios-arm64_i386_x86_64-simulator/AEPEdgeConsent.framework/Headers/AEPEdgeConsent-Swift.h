...
#ifndef AEPEDGECONSENT_SWIFT_H
#define AEPEDGECONSENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AEPEdgeConsent",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AEPMobileEdgeConsent : NSObject <AEPExtension>
...
@interface AEPMobileEdgeConsent (SWIFT_EXTENSION(AEPEdgeConsent))
/// Retrieves the current consent preferences stored in the Consent extension
/// Output example:
/// \code
/// ["consents": ["collect": ["val": "y"]]]
///
/// \endcode\param completion invoked with the current consent preferences as <code>[String: Any]</code> or
/// an <code>AEPError</code> if an unexpected error occurs or the request timed out.
///
+ (void)getConsents:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completion;
/// Merges the existing consents with the given consents. Duplicate keys will take the value of those passed in the API
/// Input example:
/// \code
/// ["consents": ["collect": ["val": "y"]]]
///
/// \endcode\param consents consents to be merged with the existing consents
///
+ (void)updateWithConsents:(NSDictionary<NSString *, id> * _Nonnull)consents;
@end
